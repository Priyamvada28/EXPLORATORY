...
SECRET_KEY = 'django-insecure-%dhp9mq8nnos=ft8^c4&)gwvmc&u35rwv7@8x7^6^2ung4qeyx'
...
# Define the channel layer for WebSockets
CHANNEL_LAYERS = {
    "default": {
...
CORS_ALLOW_CREDENTIALS = True  # Allow cookies (important for auth)

CSRF_TRUSTED_ORIGINS = ["http://localhost:3000"]
CSRF_COOKIE_SECURE = False

# CORS_ALLOWED_ORIGINS = [
#     "http://localhost:3000",  # Adjust based on frontend port
# ]
# CORS_ALLOW_ALL_ORIGINS = True
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'OU127FLU69',
        'HOST': 'localhost',   # or IP address if you're using a remote server
        'PORT': '3306',
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "apikey"  # Always "apikey", not your email
...
# Ensure media/submissions exists
UPLOAD_DIR = os.path.join(MEDIA_ROOT, "submissions")
